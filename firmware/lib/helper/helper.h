...
void *BL_MemCpy(void *dest, void *src, BL_UINT32_T length);
void *BL_MemSet(void *dest, BL_UINT8_T data, BL_UINT32_T length);
void  BL_32to8(BL_UINT8_T *dest, BL_UINT32_T src);
void  BL_8to32(BL_UINT32_T *dest, BL_UINT8_T *src);
